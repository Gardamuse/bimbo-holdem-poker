package ui.skins.milk 
{
	...
	public class PokerTooltipButton extends TooltipButton
	{	
		...
		public function PokerTooltipButton(x:Number = 0, y:Number = 0, text:String = "", width:Number = 150, height:Number = 50, callback:Function = null,
											fontSize:int=16, params:Object=null, keyConstant:int = 1, tooltip:BasicTextField=null) 
		{
			
			super(x, y, text, width, height, callback, params, keyConstant, tooltip);

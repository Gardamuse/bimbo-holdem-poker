package ui.skins.milk 
{
	...
	public class MilkButton extends Button 
	{	
		...
		public function MilkButton(x:Number=0, y:Number=0, text:String="", width:Number=150, height:Number=50, callback:Function=null, fontSize:int=16, params:Object=null, keyConstant:int = 1) 
		{

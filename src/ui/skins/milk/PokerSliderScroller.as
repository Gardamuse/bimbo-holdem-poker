package ui.skins.milk 
{
	...
	public class PokerSliderScroller extends Slider
	{	
		...
		//Hover colors
		public var topColorH:uint = 0x226622;
		public var glowColorH:uint = 0xffffff;
		public var glowColor2H:uint = 0x000000;
		public var borderColorH:uint = 0xBF9D36;
		public var barColorH:uint = 0x772222;
		
		//Pressed colors
		public var topColorP:uint = 0x226622;
		...
		public function PokerSliderScroller(x:Number = 0, y:Number = 0, prefix:String = "", suffix:String = "", width:Number = 150, height:Number = 50,
		...
		protected function drawButton(bitmap:BitmapData, width:Number, height:Number, topColor:uint, glowColor:uint, borderColor:uint):void
		{
			...
			g.drawRoundRect((width-100)*sliderFraction-0, 0, 100, height-1, 1, 1);
			g.endFill();

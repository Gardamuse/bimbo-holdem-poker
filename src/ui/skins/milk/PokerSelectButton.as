package ui.skins.milk 
{
	...
	public class PokerSelectButton extends SelectButton 
	{	
		...
		public var glowColor2P:uint = 0x999999;
		public static var borderColorP:uint = 0x999999;
		
		//Disabled colors
		public var topColorD:uint = 0x324B31;
		public var glowColorD:uint = 0xFFFFFF;
		public var glowColor2D:uint = 0xffffff;
		public var borderColorD:uint = borderColorP;
		
		//Selected colors
		public var topColorS:uint = 0x337733;
		public var glowColorS:uint = 0xffffff;
		public var glowColor2S:uint = 0xffffff;
		public var borderColorS:uint = borderColorP;
		...
		public function PokerSelectButton(x:Number = 0, y:Number = 0, text:String = "", width:Number = 150, height:Number = 50,
		...
		override protected function changeState(state:int = 0):void 
		{
			...
			{
				case NORMAL:
					TweenLite.to(this, duration, { hexColors: { topColor: topColorN, glowColor: glowColorN, glowColor2: glowColor2N, borderColor: borderColorN }, onUpdate: updateGraphic } );
					//if (lastState == HOVER) new Sfx(Assets.OUT).play();
					break;
				case HOVER:
					TweenLite.to(this, duration, { hexColors: { topColor: topColorH, glowColor: glowColorH, glowColor2: glowColor2H, borderColor: borderColorH }, onUpdate: updateGraphic } );
					//if (lastState == NORMAL) new Sfx(Assets.OVER).play();
					break;
				case DOWN:
					TweenLite.to(this, 0.0, { hexColors: { topColor: topColorP, glowColor: glowColorP, glowColor2: glowColor2P, borderColor: borderColorP}, onUpdate: updateGraphic } );
					//new Sfx(Assets.CLICK).play();
					break;
				case DISABLED:
					TweenLite.to(this, 0.0, { hexColors: { topColor: topColorD, glowColor: glowColorD, glowColor2: glowColor2D, borderColor: borderColorD}, onUpdate: updateGraphic } );
					//new Sfx(Assets.CLICK).play();
					break;
				case SELECTED:
					TweenLite.to(this, 0.0, { hexColors: { topColor: topColorS, glowColor: glowColorS, glowColor2: glowColor2S, borderColor: borderColorS}, onUpdate: updateGraphic } );
					//new Sfx(Assets.CLICK).play();
					break;
			}

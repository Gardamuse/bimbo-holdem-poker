package ui2.basic 
{
	...
	public class BasicGripSlider extends ui2.Slider
	{	
		//Normal colors
		 ...
		 * @param	o An Object containing some of the following name-value pairs:
			...
			*/
		public function BasicGripSlider(x:Number = 0, y:Number = 0, width:Number = 100, height:Number = 50, o:Object = null) 
		{
			...
			gripWidth = 100;
			if (o.hasOwnProperty("gripWidth")) gripWidth = o.gripWidth;
		...
		override protected function drawButton(bitmap:BitmapData, width:Number, height:Number, topColor:uint, glowColor:uint, borderColor:uint):void
		{
			...
			g.drawRoundRect((width-gripWidth)*sliderFraction-0, 0, gripWidth, height-1, 1, 1);
			g.endFill();
